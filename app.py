...
# runs before each request- cheks/loads user 
@app.before_request
def add_user_to_g():
    ...
    if CURR_USER_KEY in session:
        ...
        # global variable- this includes the id, name, and email, used throughout the application
...
def profile():
    ...
    if form.validate_on_submit():
        if User.authenticate(user.username, form.password.data):
            ...
            flash("Access denied. Please check your password and try again.", "danger")
...
def show_likes(user_id):
    '''Display all liked posts by user.'''
